 ...
 ***************************************************************************
 */
#ifndef _PICATTRANS_H_
#define _PICATTRANS_H_
...
#undef _
    ...
    #define _(s) wxGetTranslation((s), wxS("opencpn-statusbar_pi"))
#else // wxCHECK_VERSION(3,0,0)
#define _(s) wxGetTranslation(wxT(s), wxT("opencpn-statusbar_pi"))
